...
class CondicioMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('condicio');
		$tMap->setPhpName('Condicio');

		$tMap->setUseIdGenerator(false);

		$tMap->addPrimaryKey('CO_COND', 'CoCond', 'string', CreoleTypes::CHAR, true, 6);

		$tMap->addColumn('COND_DES', 'CondDes', 'string', CreoleTypes::VARCHAR, true, 60);

		$tMap->addColumn('DIAS_CRED', 'DiasCred', 'int', CreoleTypes::INTEGER, true, null);
