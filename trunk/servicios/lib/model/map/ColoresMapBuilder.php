...
class ColoresMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.ColoresMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('colores');
		$tMap->setPhpName('Colores');

		$tMap->setUseIdGenerator(false);

		$tMap->addPrimaryKey('CO_COL', 'CoCol', 'string', CreoleTypes::CHAR, true, 6);

		$tMap->addColumn('DES_COL', 'DesCol', 'string', CreoleTypes::VARCHAR, true, 60);
