...
class autoClientesActions extends sfActions
{
  ...
  public function executeEdit()
  {
    ...
    if ($this->getRequest()->getMethod() == sfRequest::POST)
    {
      ...
      {
        return $this->redirect('clientes/edit?co_cli='.$this->clientes->getCoCli());
      }
    }
    else
    {
  ...
  {
    $this->clientes = ClientesPeer::retrieveByPk($this->getRequestParameter('co_cli'));
  ...
  protected function getClientesOrCreate($co_cli = 'co_cli')
  {
    if (!$this->getRequestParameter($co_cli))
    {
      $clientes = new Clientes();
    }
    else
    {
      $clientes = ClientesPeer::retrieveByPk($this->getRequestParameter($co_cli));
