...
if ($this->actionName.$this->viewName == 'reciboSuccess')
{
...
else if ($this->actionName.$this->viewName == 'neSuccess')
{
  $templateName = $response->getParameter($this->moduleName.'_'.$this->actionName.'_template', $this->actionName, 'symfony/action/view');
  $this->setTemplate($templateName.$this->viewName.$this->getExtension());
}
...
if ($templateName.$this->viewName == 'reciboSuccess')
{
...
else if ($templateName.$this->viewName == 'neSuccess')
{
  $response->addHttpMeta('content-type', 'text/html', false);
  $response->addMeta('title', 'Agencia Royal 33 - Control de Servicio al Cliente', false, false);
  $response->addMeta('robots', 'index, follow', false, false);
...
else if ($templateName.$this->viewName == 'editSuccess')
{
  ...
  $response->addStylesheet('default', '', array ());
  $response->addStylesheet('main', '', array ());
  $response->addStylesheet('edit', '', array ());
}
else
{
